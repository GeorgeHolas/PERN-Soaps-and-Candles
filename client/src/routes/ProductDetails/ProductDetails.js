/**
 * ProductDetails component fetches product data from API
 * and displays product details and image. Allows user to
 * add product to cart.
 */
// ProductDetails.js
  ...
  return (
    <>
      ...
      <div className={styles.priceContainer}>
        ...
        {addToCartMessage && (
          <p className={styles.addToCartMessage}>{addToCartMessage}</p>
        )}
