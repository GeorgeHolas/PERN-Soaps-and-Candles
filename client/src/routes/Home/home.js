...
function Home() {
  useEffect(() => {
    const fadeInImages = () => {
      const images = document.querySelectorAll(`.${styles.imageOne}, .${styles.imageTwo}, .${styles.text}`);
    ...
    return (
      <div className={styles.home}>
        ...
        <video className={styles.introVideo} autoPlay loop muted>
          <source src="https://assets.mixkit.co/videos/preview/mixkit-arrangement-of-natural-soaps-and-candles-2805-large.mp4" type="video/mp4" />
      ...
      <div className={styles.container}>
       <div className={styles.historyContainer}>
        <div className={styles.history}>
          <h2>Welcome to <span className={styles.whiteTextTwo}>our store</span></h2>
          <p>
          ...
          <p>
            ...
            Thank you for being part of our journey. We invite you to immerse yourself in the world of LIŠKA Soaps & Candles.
            Crafted with Love, Inspired by Nature.
            </p>
        </div>
          <div className={styles.imageContainer}>
          <h2>Our Products<span className={styles.whiteText}> are handcrafted</span></h2>
            <div className={styles.imageOne}></div>
            <p className={styles.text}>
              <strong>Our handmade soaps</strong> are a testament to the harmonious blend of natural ingredients and skilled craftsmanship. Immerse yourself in the luxurious lather and captivating scents that each soap bar offers. From the calming notes of lavender to the invigorating freshness of citrus, every soap is a sensory journey, carefully curated to pamper your skin and soothe your senses.
            </p>

            <div className={styles.imageTwo}></div>
            <p className={styles.text}>
              <strong>We believe in the power</strong> of natural ingredients. Our soaps are formulated with nourishing oils, botanicals, and premium essential oils, ensuring a gentle and indulgent cleansing experience. Our candles are made with eco-friendly wax, and we prioritize sustainable practices to minimize our environmental footprint. Our handmade soaps are a testament to the harmonious blend of natural ingredients and skilled craftsmanship. Immerse yourself in the luxurious lather and captivating scents that each soap bar offers. From the calming notes of lavender to the invigorating freshness of citrus, every soap is a sensory journey, carefully curated to pamper your skin and soothe your senses.
            </p>
          </div>
        </div>
      <Footer />
